...
import getProblemsPage from "@/app/problems/getProblemsPage"; 
...
function ProblemsPage({ session }) { 
  ...
  const fetchMoreData = async () => {
    try {
      ...
      // Set hasMore to false if there's no more data to fetch
      // For example: setHasMore(newData.length > 0);
    } catch (error) { 
      // Handle error
  ...
  useEffect(() => { 
    ...
    return ( 
        <>
          <section id="problems" className="pt-[120px] pb-[120px]">   
            <div className="container">  
              <InfiniteScroll 
                ...
                endMessage={<div role="status" className="flex justify-center align-center"><p>No more problems to load...</p></div>}  
